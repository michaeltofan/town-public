...
(function (root, factory) {
  ...
  "milano-signal-1": {
    ...
    "it": {
      ...
      "latestUpdate": "Il segnale resta locale e aperto. Nessuna conferma rilevante di intervento è ancora disponibile.",
    ...
    "en": {
      ...
      "latestUpdate": "The signal remains local and open. No relevant confirmation of intervention is available yet.",
    ...
    "es": {
      ...
      "latestUpdate": "La señal sigue siendo local y abierta. Aún no hay confirmación relevante de intervención.",
    ...
    "de": {
      ...
      "latestUpdate": "Das Signal bleibt lokal und offen. Derzeit liegt noch keine relevante Bestätigung einer Maßnahme vor.",
    ...
    "ro": {
      ...
      "latestUpdate": "Semnalul rămâne local și deschis. Nu există încă o confirmare relevantă a unei intervenții.",
  ...
  "milano-signal-2": {
    ...
    "it": {
      ...
      "latestUpdate": "I residenti riferiscono di aver già segnalato il Comune. Il segnale resta in monitoraggio locale.",
    ...
    "en": {
      ...
      "latestUpdate": "Residents say they have already reported it to the municipality. The signal remains under local monitoring.",
    ...
    "es": {
      ...
      "latestUpdate": "Los vecinos indican que ya lo han señalado al Ayuntamiento. La señal permanece en seguimiento local.",
    ...
    "de": {
      ...
      "latestUpdate": "Anwohner berichten, die Störung bereits der Gemeinde gemeldet zu haben. Das Signal bleibt in lokaler Beobachtung.",
    ...
    "ro": {
      ...
      "latestUpdate": "Locuitorii spun că au semnalat deja primăriei. Semnalul rămâne în monitorizare locală.",
  ...
  "milano-signal-3": {
    ...
    "it": {
      ...
      "latestUpdate": "Il segnale resta aperto. Non risultano ancora indicazioni aggiornate su durata o percorso alternativo.",
    ...
    "en": {
      ...
      "latestUpdate": "The signal remains open. There is still no updated information on duration or an alternative route.",
    ...
    "es": {
      ...
      "latestUpdate": "La señal permanece abierta. Aún no hay indicaciones actualizadas sobre duración o recorrido alternativo.",
    ...
    "de": {
      ...
      "latestUpdate": "Das Signal bleibt offen. Es gibt noch keine aktualisierte Angabe zu Dauer oder Ausweichweg.",
    ...
    "ro": {
      ...
      "latestUpdate": "Semnalul rămâne deschis. Nu există încă indicații actualizate privind durata sau un traseu alternativ.",
  ...
  "munich-signal-1": {
    ...
    "en": {
      ...
      "latestUpdate": "The signal remains local and open. No confirmed measure is available yet.",
    ...
    "es": {
      ...
      "latestUpdate": "La señal sigue siendo local y abierta. Aún no hay una medida confirmada.",
    ...
    "it": {
      ...
      "latestUpdate": "Il segnale resta locale e aperto. Non risulta ancora una misura confermata.",
    ...
    "ro": {
      ...
      "latestUpdate": "Semnalul rămâne local și deschis. Nu există încă o măsură confirmată.",
  ...
  "munich-signal-2": {
    ...
    "de": {
      ...
      "latestUpdate": "Anwohner berichten, die Störung bereits gemeldet zu haben. Das Signal bleibt in lokaler Beobachtung.",
      "statusNote": "„Gemeldet“ heißt, dass das Thema lokal sichtbar gemacht wurde. Es bestätigt keine Reparatur, keine formale Übernahme und keinen Zeitplan."
    },
    "en": {
      ...
      "latestUpdate": "Residents report they have already flagged the fault. The signal stays under local observation.",
    ...
    "es": {
      ...
      "latestUpdate": "Los vecinos indican que ya han avisado de la avería. La señal permanece en observación local.",
    ...
    "it": {
      ...
      "latestUpdate": "I residenti riferiscono di aver già segnalato il guasto. Il segnale resta in osservazione locale.",
    ...
    "ro": {
      ...
      "latestUpdate": "Locuitorii spun că au semnalat deja defectul. Semnalul rămâne în observație locală.",
  ...
  "munich-signal-3": {
    ...
    "en": {
      ...
      "latestUpdate": "The signal remains open. There is still no updated note on duration or a diversion.",
    ...
    "es": {
      ...
      "latestUpdate": "La señal permanece abierta. Aún no hay una nota actualizada sobre duración o desvío.",
    ...
    "it": {
      ...
      "latestUpdate": "Il segnale resta aperto. Non c’è ancora un’indicazione aggiornata su durata o diversione.",
    ...
    "ro": {
      ...
      "latestUpdate": "Semnalul rămâne deschis. Nu există încă o mențiune actualizată privind durata sau o ocolire.",

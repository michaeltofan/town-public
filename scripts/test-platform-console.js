...
assert(js.includes("components.backup"), "status renders Backup component");
assert(js.includes("components.restore"), "status renders Restore component");
...
assert(html.includes('id="status-backup-summary"'), "backup summary present");
assert(html.includes('id="status-restore-summary"'), "restore summary present");
assert(js.includes("/v1/platform/uptime"), "uptime path");
assert(js.includes("/v1/platform/alerts"), "alerts path");
assert(js.includes("/v1/platform/backup"), "backup path");
assert(js.includes("/v1/platform/restore"), "restore path");
assert(js.includes("loadUptime"), "uptime loader");
assert(js.includes("loadAlerts"), "alerts loader");
assert(js.includes("loadBackup"), "backup loader");
assert(js.includes("loadRestore"), "restore loader");
...
assert(js.includes("/export"), "investigation export path");
assert(js.includes("downloadInvestigationPack"), "investigation export helper");
assert(html.includes('id="investigate-export"'), "investigation export button");
assert(js.includes("town-investigation-"), "investigation pack filename");
